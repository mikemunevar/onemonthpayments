...
growth_hacking = Product.create(
    ...
    download_url:   "https://s3.amazonaws.com/one-month-stripe-payments-0522/Alisons+Cupcakes.jpg",
    ...
    description:    %{
        <p>A growth hacker is a rare combination: someone with the right marketing and technical skills who can come up with clever marketing hacks and also track their results.</p>
            ...
            <ul class="no-indent">
                ...
                <li>Resources and tools youll need to know</li>
            </ul>
    },
    
    author_description: %{
         <p>Hey, Im Mattan Griffel, co-founder of the Y Combinator backed <a href="http://www.onemonth.com" target="_blank">One Month</a> where I teach the best selling One Month Rails and One Month Growth Hacking.</p>
                <p>Why take my class? In the past Ive advised companies like Pepsico, Bloomberg, GM, NYSE, and JPMorgan on growth hacking best practices. Ive also spoken at New York University, Cooper Union and First Round Capital. My goal is to help you and other entrepreneurs rapidly grow your business. 
                </p>
...
growth_hacking_monthly = Product.create(
    ...
    price:      "4.99",
    sku:        "GROHACK2",
    details:    "We''ll charge you montly for unlimited access to our mentoring team.",
    download_url:   "https://s3.amazonaws.com/one-month-stripe-payments-0522/Alisons+Cupcakes.jpg",
